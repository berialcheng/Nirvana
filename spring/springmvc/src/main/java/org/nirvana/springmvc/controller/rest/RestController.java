package org.nirvana.springmvc.controller.rest;
...
public class RestController {
	...
	@ResponseBody
	public Person getPersonInXml(@PathVariable String firstname,
	...
	/**
	 * appPath/servletPath/rest/json/book POST {"name":"dummyBookName"}
	 * 
	 * @param book
	 * @return
	 */
	...
	@ResponseBody
	public String complexRequestMapping2(@PathVariable String name,
	...
	@RequestMapping(value = "/exception/runtime")
	@ResponseBody
	public String exceptionRequestMapping() {
		if (true)
			throw new IndexOutOfBoundsException("dummy exception");
		return "success";
	}
